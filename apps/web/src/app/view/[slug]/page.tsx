      ...
      >
        <SheetContent side="left" className="w-full overflow-y-auto bg-background/80 backdrop-blur-lg">
          ...
          <Accordion type="single" defaultValue="clipboard" className="w-full">
            ...
            <div
              className="flex flex-1 items-center justify-between py-4 font-medium transition-all hover:underline [&[data-state=open]>svg]:rotate-180 hover:cursor-pointer"
              onClick={() => {
                fetch(`/api/session/${params.slug}/addscreen`)
              }}
            >
              <div className="flex items-center gap-4">
                <ScreenShare className="size-9 rounded bg-accent p-1.5" /> Add screen
              </div>
